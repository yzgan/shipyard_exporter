...
module ShipyardExporter
  ...
  module Exportable
    ...
    class_methods do
      ...
      def export(format:, attributes: nil, row_titles: nil, decorate: false)
        row_titles ||= attributes ? csv_row_title(attributes) : exportable_row_title
        attributes ||= exportable_scope
